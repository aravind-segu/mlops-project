...
Opening a pull request will trigger a[workflow](../.github/workflows/my-mlops-project-run-tests.yml) 
...
* [Staging model in UC](https://e2-dogfood.staging.cloud.databricks.com/explore/data/models/staging/my-mlops-project/my-mlops-project-model)
* [Prod model in UC](https://e2-dogfood.staging.cloud.databricks.com/explore/data/models/prod/my-mlops-project/my-mlops-project-model)
. 
