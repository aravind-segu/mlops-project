...
dbutils.widgets.text(
    "model_name", "dev.aravind_test.my-mlops-project-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.aravind_test.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.aravind_test.trip_dropoff_features",
